...
(function() {
  ...
  Growlyflash = (function() {
    var _build_shorthand, _titleize, h;
    ...
    _build_shorthand = function(type) {
      return function(msg) {
        return $.growlyflash(new Growlyflash.FlashStruct(msg, type));
      };
    };
  ...
  Growlyflash.Listener = (function() {
    ...
    Stack = (function() {
      ...
      Stack.prototype.push = function(alert, dumped) {
        $.growlyflash(alert);
        return this.items.push(dumped != null ? dumped : alert.toString());
      };
    ...
    function Listener(context) {
      ...
      ($(context)).on(EVENTS, (function(_this) {
        return function(_, xhr) {
          return _this.stack.push_only_fresh(process_from_header(xhr.getResponseHeader(HEADER)));
        };
      })(this));
    }
